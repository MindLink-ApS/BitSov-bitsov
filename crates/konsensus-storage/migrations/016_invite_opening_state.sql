-- ONB5d: add in-flight state for idempotent auto-channel opens

CREATE TABLE invites_issued_onb5d_new (
    id                                BLOB PRIMARY KEY,
...
INSERT INTO invites_issued_onb5d_new (
    id,
    invitee_pubkey,
    expiry_unix,
...
ALTER TABLE invites_issued_onb5d_new RENAME TO invites_issued;
